...
class TabBarVC: UITabBarController, UITabBarControllerDelegate {
    ...
    //MARK: - Component    
    lazy var discoverNav = navWith(vc: DiscoverVC(), title: "发现", image: #imageLiteral(resourceName: "tabbar_icon_find"), selectedImage: #imageLiteral(resourceName: "tabbar_icon_findsel"))
    
    lazy var liveNav = navWith(vc: MomentListVC(), title: "直播", image: #imageLiteral(resourceName: "tabbar_icon_room"), selectedImage: #imageLiteral(resourceName: "tabbar_icon_roomsel"))
