...
class TabBarVC: UITabBarController, UITabBarControllerDelegate {
    ...
    lazy var liveNav = navWith(vc: PlazaVC(), title: "直播", image: #imageLiteral(resourceName: "tabbar_icon_room"), selectedImage: #imageLiteral(resourceName: "tabbar_icon_roomsel"))
