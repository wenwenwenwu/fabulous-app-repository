...
class PlazaCell_Type: PlazaCell {
    ...
    func setupSceneTypeLayout() {
        setup(imageSize: CGSize(width: rem(94), height: rem(97)), imageRadius: rem(5), imageSpacing: rem(8), padding: UIEdgeInsets(top: rem(0), left: rem(10), bottom: rem(20), right: rem(10)))
    }
    
    func setupGoalTypeLayout() {
        setup(imageSize: CGSize(width: rem(89), height: rem(92)), imageRadius: rem(5), imageSpacing: rem(8), padding: UIEdgeInsets(top: rem(0), left: rem(10), bottom: rem(20), right: rem(10)))
    }
